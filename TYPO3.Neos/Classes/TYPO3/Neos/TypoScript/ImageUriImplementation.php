...
use TYPO3\Media\Domain\Model\ThumbailConfiguration;
...
class ImageUriImplementation extends AbstractTypoScriptObject {
	...
	public function evaluate() {
		...
		$thumbnailConfiguration = new ThumbailConfiguration($this->getWidth(), $this->getMaximumWidth(), $this->getHeight(), $this->getMaximumHeight(), $this->getAllowCropping(), $this->getAllowUpScaling());
